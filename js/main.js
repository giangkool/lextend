...
.config(['$routeProvider', function ($routeProvider) {
  $routeProvider
    ...
    .when("/edit-material/:uri", {templateUrl: "partials/editmaterial.html", controller:"EditMaterialCtrl"})
    ...
    .when("/search", {templateUrl: "partials/searchin.html", controller:"MaterialdetailCtrl"})
